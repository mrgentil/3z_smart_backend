                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="item-content">
                            ...
                            <div class="item-number"><span class="counter" data-num="{{-- {{ $userCount }} --}}">{{-- {{ $userCount }} --}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="item-content">
                            ...
                            <div class="item-number"><span class="counter" data-num="{{-- {{ $productCount }} --}}">{{-- {{ $productCount }} --}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
